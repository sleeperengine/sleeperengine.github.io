...
import robob from '@images/robots/robob.png';
import robob_render from '@images/robots/robob_render_front_2.png'
import robob_game from '@images/robots/robob_game_crop.png'

import arms from '@images/player/arms.png'
import arms_render from '@images/player/arms_render.png'

import concept from '@images/player/concept.png'
import main_character from '@images/player/main_character.png'

import turbot from '@images/robots/turbot.png'
import turbot2 from '@images/robots/turbot2.png'

import bigbot from '@images/robots/bigbot.png'
import bigbot2 from '@images/robots/bigbot2.png'
...
<div style="display: flex; justify-content: space-between;">
  <Image src={concept} alt="Player character concept art" style="width: 79.5%;" />
  <Image src={main_character} alt="Player character concept art" style="width: 19.5%;" />
</div>
...
<div style="display: flex; justify-content: space-between;">
  <Image src={arms} alt="Player arms' concept art" style="width: 45%;" />
  <Image src={arms_render} alt="Player arms' Blender render" style="width: 54%;" />
</div>
...
<div style="display: flex; justify-content: space-between;">
  <Image src={robob} alt="Robob concept art" style="width: 29%;" />
  <Image src={robob_render} alt="Robob Blender render" style="width: 45%;" />
  <Image src={robob_game} alt="Robob Godot concept" style="width: 24%;" />
</div>
...
<div style="display: flex; justify-content: space-between;">
  <Image src={bigbot2} alt="BigBot concept art" style="width: 49%;" />
  <Image src={bigbot} alt="BigBot concept art" style="width: 49%;" />
</div>
...
<div style="display: flex; justify-content: space-between;">
  <Image src={turbot} alt="TurBot concept art" style="width: 49%;" />
  <Image src={turbot2} alt="TurBot concept art" style="width: 49%;" />
</div>
